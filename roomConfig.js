module.exports = {
    run: function () {
        ...
        if (Game.time % rebootTime == 0) {
            !Memory.roomConfig ? Memory.roomConfig = {} : console.log('roomConfig is Already')

            let myRooms = ['E48S16', 'E49S16', 'E49S15', 'E49S14', 'E48S14', 'E47S14']
            ...
            for (var name of myRooms) {
                ...
                if (!Memory.roomConfig.name.centerLink) {
                    ...
                    if (Game.rooms[name].storage) {
                        storages = Game.getObjectById(Game.rooms[name].storage.id)
                    }
                ...
                if (!Memory.roomConfig.name.labs) {
                    let labs
                    let labflag = Game.flags.labFlag

                    if (labflag) {
                        labs = labflag.pos.findClosestByRange(FIND_STRUCTURES, {
